  ...
  return (
    <div style={{ backgroundColor: '#F9FAFB', paddingTop: '80px' }}>
      ...
      <section className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(135deg, #112744 0%, #1A3352 50%, #112744 100%)' }}>
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: `url('/manus-storage/hero_bg_b0288072.jpg')`, backgroundSize: 'cover' }} />
        <div className="container relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-xs font-semibold tracking-widest mb-3" style={{ color: '#0D9488' }}>DIGITAL & WEB</p>
            <h1 className="text-6xl lg:text-8xl font-black leading-none mb-6" style={{ fontFamily: 'Barlow Condensed, sans-serif', color: '#111827' }}>
              YOUR DIGITAL<br />
              <span style={{ color: '#0D9488' }}>PRESENCE,</span><br />
              TRANSFORMED.
            </h1>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold mb-6 tracking-widest" style={{ backgroundColor: 'rgba(45, 212, 191, 0.12)', border: '1px solid rgba(45, 212, 191, 0.3)', color: '#0D9488' }}>
              ...
              <h2 className="text-5xl font-black mb-6 text-white" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>
                7 PAGES.<br />
                <span style={{ color: '#0D9488' }}>48 HOURS.</span><br />
                FROM £799.
              </h2>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-xs font-semibold tracking-widest" style={{ color: '#0D9488' }}>RAPID DELIVERY</span>
                </div>
                <div className="text-6xl font-black mb-1 text-white" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>£799</div>
                <p className="text-sm mb-8" style={{ color: '#6B7280' }}>Complete 7-page website, live in 48 hours</p>
                ...
                <div className="space-y-3 mb-8">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between py-2" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                      <span className="text-sm" style={{ color: '#6B7280' }}>{page}</span>
      ...
      <section className="py-24" style={{ backgroundColor: '#F0FDFB' }}>
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
            <p className="text-xs font-semibold tracking-widest mb-3" style={{ color: '#0D9488' }}>FULL DIGITAL SERVICES</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {webServices.map((svc, i) => (
              <motion.div
                ...
                style={{ backgroundColor: '#F9FAFB', border: `1px solid ${svc.color}20` }}
              >
      ...
      <section className="py-24">
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <p className="text-xs font-semibold tracking-widest mb-3" style={{ color: '#0D9488' }}>SECTORS WE SERVE</p>
            <h2 className="text-5xl font-black text-white" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {sectors.map((sector, i) => (
              <motion.span
                ...
                style={{ backgroundColor: '#F0FDFB', border: '1px solid rgba(45, 212, 191, 0.2)', color: '#6B7280' }}
              >
                {sector}
              </motion.span>
            ))}
      ...
      {/* CTA */}
      <section className="py-20" style={{ backgroundColor: '#F0FDFB', borderTop: '1px solid rgba(45, 212, 191, 0.25)' }}>
        <div className="container text-center">
          <h2 className="text-5xl font-black mb-4 text-white" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>
            READY TO TRANSFORM YOUR DIGITAL PRESENCE?
          </h2>
          <p className="text-lg mb-8" style={{ color: '#6B7280' }}>Talk to us today. Your new website could be live by tomorrow.</p>
          <Link href="/contact">
            <button
