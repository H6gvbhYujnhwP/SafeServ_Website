        ...
        <div className="container relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-6xl lg:text-8xl font-black leading-none mb-6" style={{ fontFamily: 'Barlow Condensed, sans-serif', color: '#FFFFFF' }}>
              IT SUPPORT<br />
              <span style={{ color: '#2DD4BF' }}>DONE</span><br />
              DIFFERENTLY.
            </h1>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              <p className="text-xs font-semibold tracking-widest mb-3" style={{ color: '#2DD4BF' }}>OUR IT PARTNER</p>
              <h2 className="text-5xl font-black mb-6 text-white" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>
                POWERED BY<br />
                <span style={{ color: '#2DD4BF' }}>SWEETBYTE</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {["25+ years experience", "No lock-in contracts", "Remote & on-site support", "MOA included as standard"].map((item, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <CheckCircle2 size={14} style={{ color: '#2DD4BF', flexShrink: 0 }} />
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(45, 212, 191, 0.15)' }}>
                    <Zap size={20} style={{ color: '#2DD4BF' }} />
                  </div>
                  <div>
                    <p className="text-xs tracking-widest" style={{ color: '#2DD4BF' }}>UK FIRST</p>
                ...
                <div className="pt-6" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
                  <p className="text-xs tracking-widest mb-3" style={{ color: '#2DD4BF' }}>WHAT MOA DELIVERS</p>
